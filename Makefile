...
# Object Files
SERVER_OBJS = $(OBJ_DIR)/server.o $(OBJ_DIR)/shared_mem.o $(OBJ_DIR)/game_logic.o $(OBJ_DIR)/logger.o $(OBJ_DIR)/scheduler.o $(OBJ_DIR)/scores.o
...
# IPC Cleanup (Manual removal of shared memory/semaphores)
clean-ipc:
